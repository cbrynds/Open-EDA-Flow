...
proc write_ppa_csv { flow_type } {
  global design platform power_corner result_dir
  set csv_path [file join $result_dir "ppa.csv"]
  set write_header [expr {![file exists $csv_path]}]
  set fp [open $csv_path a]
  if { $write_header } {
    puts $fp "design,platform,flow,area_um2,worst_slack_ns,clock_period_ns,power_w,utilization_pct"
  }
  ...
  puts $fp "$design,$platform,$flow_type,$area,$slack,$period,$power,$util"
  close $fp
